<template>
    <section>
        <td-table
                title="支付记录"
                ref="table"
                :get-item-by-id="parameter=>mallPayLogGetById({id:parameter.id})"
            ...
            <template #Search="{formState}">
                    <a-form-item label="支付编号" name="id">
            ...
            <template #Columns>
                    <a-table-column title="支付编号" data-index="id" align="center" :sorter="true" />
                    <a-table-column title="订单号" data-index="orderId" align="center" :sorter="true" />
                    <a-table-column title="支付参数" data-index="payParam" align="center"  />
                    <a-table-column title="支付结果" data-index="payResult" align="center"  />
