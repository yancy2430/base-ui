...
export function mallStoreCateGetById (queryParams,options) {
    ...
    url: serviceUrl+'/tongdao/mallStoreCate/getById',
    method: 'POST',
    params:queryParams,
    headers: {
...
export function mallStoreCateSave (data,options) {
    return request(Object.assign({
    url: serviceUrl+'/tongdao/mallStoreCate/save',
    method: 'POST',
...
export function mallStoreCateRemoveById (queryParams,options) {
    return request(Object.assign({
    url: serviceUrl+'/tongdao/mallStoreCate/removeById',
    method: 'POST',
    params:queryParams,
    headers: {
    'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
...
export function mallStoreCatePage (queryParams,options) {
    return request(Object.assign({
    url: serviceUrl+'/tongdao/mallStoreCate/page',
    method: 'POST',
    params:queryParams,
    headers: {
    'Content-Type': 'application/x-www-form-urlencoded;charset=UTF-8'
